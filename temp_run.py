...
prob.opt.options.max_iter = 30 # Longer run for projection check
if run_mode == 1:
    ...
    prob.opt.functions.objective_scale = 20.0
    prob.opt.functions.constraint_scale = 1.0
    prob.opt.options.move_limit = 0.05
    prob.opt.parameters.slimit = 2.4 
    prob.opt.parameters.vol_penal_min = 1.0
    prob.opt.parameters.vol_penal_max = 20.0
# ===============================================
